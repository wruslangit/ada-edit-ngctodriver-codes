...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_main_ada_edit_ngctodriver_codes" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#ababe9b2#;
   pragma Export (C, u00001, "main_ada_edit_ngctodriver_codesB");
   ...
   u00167 : constant Version_32 := 16#920c8fbc#;
   pragma Export (C, u00167, "pkg_ada_cnc_driver_codesB");
   u00168 : constant Version_32 := 16#dae064d9#;
   pragma Export (C, u00168, "pkg_ada_cnc_driver_codesS");
   u00169 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00169, "gnatS");
   u00170 : constant Version_32 := 16#dbf24c7a#;
   pragma Export (C, u00170, "gnat__string_splitB");
   u00171 : constant Version_32 := 16#3d848bbe#;
   ...
   u00184 : constant Version_32 := 16#1a72532b#;
   pragma Export (C, u00184, "pkg_ada_datetime_stampB");
   u00185 : constant Version_32 := 16#4dd244a1#;
   pragma Export (C, u00185, "pkg_ada_datetime_stampS");
   u00186 : constant Version_32 := 16#9a2e29aa#;
   pragma Export (C, u00186, "ada__calendarB");
   u00187 : constant Version_32 := 16#c4f07049#;
   pragma Export (C, u00187, "ada__calendarS");
   u00188 : constant Version_32 := 16#10f667b3#;
   pragma Export (C, u00188, "ada__calendar__formattingB");
   u00189 : constant Version_32 := 16#f87a094f#;
   pragma Export (C, u00189, "ada__calendar__formattingS");
   u00190 : constant Version_32 := 16#e3cca715#;
   pragma Export (C, u00190, "ada__calendar__time_zonesB");
   u00191 : constant Version_32 := 16#f21593b3#;
   pragma Export (C, u00191, "ada__calendar__time_zonesS");
   ...
   u00197 : constant Version_32 := 16#b517e56d#;
   pragma Export (C, u00197, "system__img_lldS");
   u00198 : constant Version_32 := 16#bd3715ff#;
   pragma Export (C, u00198, "system__img_decB");
   u00199 : constant Version_32 := 16#e818e5df#;
   pragma Export (C, u00199, "system__img_decS");
   u00200 : constant Version_32 := 16#41247c34#;
   pragma Export (C, u00200, "pkg_ada_linestring_splitB");
   u00201 : constant Version_32 := 16#55e1913c#;
   pragma Export (C, u00201, "pkg_ada_linestring_splitS");
   ...
   u00208 : constant Version_32 := 16#e5b19cf0#;
   pragma Export (C, u00208, "pkg_ada_realtime_delaysB");
   u00209 : constant Version_32 := 16#f93ecfaf#;
   pragma Export (C, u00209, "pkg_ada_realtime_delaysS");
   u00210 : constant Version_32 := 16#2353cf5b#;
   pragma Export (C, u00210, "ada__real_time__delaysB");
   u00211 : constant Version_32 := 16#0a5c26d7#;
   pragma Export (C, u00211, "ada__real_time__delaysS");
   u00212 : constant Version_32 := 16#f7159f94#;
   pragma Export (C, u00212, "pkg_ada_vectorize_splitlineB");
   u00213 : constant Version_32 := 16#04249b8c#;
   pragma Export (C, u00213, "pkg_ada_vectorize_splitlineS");
   ...
   --  gnat.string_split%s
   --  gnat.string_split%b
   --  pkg_ada_cnc_driver_codes%s
   --  pkg_ada_cnc_driver_codes%b
   ...
   --  main_ada_edit_ngctodriver_codes%b
